...
// Assets
import ContactImg1 from "../../assets/img/madrid.jpg";
import ContactImg2 from "../../assets/img/mexico.jpg";
import ContactImg3 from "../../assets/img/barca.jpg";
      ...
      <div className="lightBg">
        <div className="container">
          <HeaderInfo>
            ...
            <p className="font13">
              Ready to kick off your dream soccer experience? Let's chat! Get in touch today and start planning 
              <br />
              your next unforgettable tour with us.
            </p>
          </HeaderInfo>
